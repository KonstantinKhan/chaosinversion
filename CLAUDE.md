...
| `chaosinversion-inmemory`         | The module containing in-memory implementations of data access interfaces and services                   | [chaosinversion-inmemory](./docs/modules/chaosinversion-inmemory.md)                    |
